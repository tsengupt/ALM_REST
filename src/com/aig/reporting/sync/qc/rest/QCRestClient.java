...
import com.aig.reporting.sync.qc.rest.util.Q;
import com.aig.reporting.sync.qc.rest.util.ServerException;
import com.aig.reporting.sync.qc.rest.util.XML;
import com.aig.reporting.sync.qc.rest.util.XML.BY;
    ...
    public void login() throws Exception {
        ...
        if (loginRes != null) {            
            ...
            if (sessionRes.get("status").equals(HttpStatus.CREATED_201)) {
            	...
            	System.out.println("session not available status : "+ sessionRes.get("status"));
            }
